...
from zondapro.enums import Estructura
from zondapro.enums import PosicionCamara, SistemaResistente, Unidad
from zondapro.graficos.actores import color_3d
from zondapro.graficos.escenas import (
    geometrias,
