...
from zondapro.widgets.custom import (
    WidgetSinBorde,
    WidgetPanel,
    WidgetLogo,
    WidgetBotonModulo,
...
from zondapro.widgets.dialogos import DialogoConfiguracion
from zondapro.widgets.modulos import WidgetModuloEdificio, WidgetModuloCubiertaAislada, WidgetModuloCartel
