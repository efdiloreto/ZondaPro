...
from zondapro.cirsoc.geometria.cubiertas import Cubierta
from zondapro.cirsoc.geometria.utils_alturas import array_alturas
from zondapro.enums import TipoCubierta
