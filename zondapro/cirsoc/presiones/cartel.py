...
from zondapro.cirsoc.presiones.base import PresionesBase

if TYPE_CHECKING:
    import numpy as np
    from zondapro.cirsoc.factores import Rafaga
    from zondapro.cirsoc import geometria
    from zondapro.enums import CategoriaEstructura, CategoriaExposicion
