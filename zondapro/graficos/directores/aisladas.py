...
from zondapro.graficos.actores import actores_poligonos, color_3d
from zondapro.graficos.directores.utils_geometria import coords_zona_cubierta, coords_zona_cubierta_desde_proyeccion

if TYPE_CHECKING:
    from zondapro.cirsoc import CubiertaAislada
