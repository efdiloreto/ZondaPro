...
from zondapro.graficos.actores import (
    actores_poligonos,
    crear_poly_data,
    clip_poly_data,
    ActorPresion,
)
from zondapro.graficos.directores.utils_geometria import (
...
from zondapro.graficos.directores.utils_iter import aplicar_func_recursivamente

if TYPE_CHECKING:
    from zondapro.cirsoc import Edificio
    from zondapro.tipos import Punto2D
